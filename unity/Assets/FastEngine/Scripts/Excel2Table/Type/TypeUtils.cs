...
namespace FastEngine.Core.Excel2Table
{
	public class TypeUtils
	{
		...
		/// <returns></returns>
		private static string[] ContentSeparator(string content, char[] separator = null)
		{
			return content.Split(separator == null ? new char[] { ',' } : separator, StringSplitOptions.RemoveEmptyEntries);
		}
		...
		public static I18NObject ContentToI18NObjectValue(string content)
		{
			...
			string[] datas = ContentSeparator(content);
