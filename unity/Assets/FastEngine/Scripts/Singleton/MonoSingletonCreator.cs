...
namespace FastEngine
{
    public class MonoSingletonCreator
    {
        public static T CreateMonoSingleton<T>() where T : MonoBehaviour, ISingleton
        {
            ...
            if (instance == null && Application.isPlaying)
            {
                ...
                if (instance == null)
                {
                    ...
                    {
                        MonoSingletonPath defineAttri = attribute[i] as MonoSingletonPath;
                        if (defineAttri == null)
                        {
                            continue;
                        }
        ...
        public static T CreateComponentOnGameObject<T>(string path, bool dontDestroy) where T : MonoBehaviour
        {
